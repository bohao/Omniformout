...
$Lightning._delegate = (function() {
	...
	function addScripts(urls, onload) {
		...
		script.type = "text/javascript";
				...
				// url = url.replace(/poc-wc.cs6.force.com/g, 'poc-myaccount.cs6.force.com');
				...
				xhr.onreadystatechange = function() {
					if (xhr.readyState == 4 && xhr.status == 200) {
						...
						if (errorMarker == -1) {
							...
							var replacedResponse = xhr.responseText.replace(/\bpoc-wc.cs6.force.com\b/gm, 'poc-myaccount.cs6.force.com');

							var config = JSON.parse(replacedResponse);
							...
							var startIndex = (replacedResponse.startsWith("*/")) ? 2 : 0;
							var jsonExcptn = replacedResponse.substring(startIndex,errorMarker);
